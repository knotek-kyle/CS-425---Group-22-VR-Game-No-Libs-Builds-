...
public class Slice : MonoBehaviour
{
    ...
    public static event System.EventHandler<SliceEventInfo> OnSlice;
    ...
    public void ComputeSlice(Vector3 sliceNormalWorld, Vector3 sliceOriginWorld)
    {
        ...
        if (mesh != null)
        {
            ...
            if (this.fragmentRoot == null)
            {
                ...
                sliceCreationTrigger(this.fragmentRoot);
            }
    ...
    void sliceCreationTrigger(GameObject obj)
    {
        OnSlice?.Invoke(this, new SliceEventInfo(obj));
        OnFragmentCreation?.Invoke(this, new FragmentCreationEventInfo(obj));
    }
